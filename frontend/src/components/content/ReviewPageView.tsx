  ...
  return (
    <div className="archive-landing global-catalog-landing dispatcher-header-page review-page-template">
      <HeroLead
        ...
        layout="mainLike"
      />
      <Section className="section review-page">
        <div className="container review-detail">
          ...
          <div>
            ...
            <h2 className="review-detail__title">{title}</h2>
            <div className="content" dangerouslySetInnerHTML={{ __html: rewriteWordPressHtml(review.body) }} />
            {review.source_url ? (
              <ActionLink href={review.source_url} target="_blank" rel="noreferrer" variant="outline">
                Источник
              </ActionLink>
            ) : null}
          </div>
