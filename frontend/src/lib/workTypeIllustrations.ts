...
const GENERATED_WORK_TYPE_ILLUSTRATIONS_BY_SLUG: Record<string, string> = {
  ...
  "otsypka-uchastka": `${GENERATED_WORK_TYPE_ILLUSTRATIONS_DIR_URL}/otsypka-uchastka.png`,
  ...
  "podgotovka-uchastka-pod-stroitelstvo": `${GENERATED_WORK_TYPE_ILLUSTRATIONS_DIR_URL}/podgotovka-uchastka-pod-stroitelstvo.png`,
